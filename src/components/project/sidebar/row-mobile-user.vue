...
<script>
  export default {
    ...
    computed: {
      ...
      isSelected() {
      return this.selectedUsers.some(user => user.id === this.mobileUser.id);
    }
    },
    methods: {
      showCode() {
      ...
      toggleSelection() {
      const userIndex = this.selectedUsers.findIndex(user => user.id === this.mobileUser.id);
      if (userIndex > -1) {
        this.selectedUsers.splice(userIndex, 1);
      } else {
        this.selectedUsers.push(this.mobileUser);
      }
    }
    }
  };
