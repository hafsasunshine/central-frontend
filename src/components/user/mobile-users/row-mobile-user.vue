...
<!--created by hafsa-->
<template>
  <tr class="field-key-row" :class="{ success: mobileUser.id === highlighted }">
    <td class="display-name">
      <span v-tooltip.text>{{ mobileUser.displayName }}</span>
    </td>
    <td>
      <time-and-user :iso="mobileUser.createdAt" :user="mobileUser.createdBy"/>
    </td>
    <td><date-time :iso="mobileUser.lastUsed"/></td>
    <td>
      <a v-if="mobileUser.token != null" ref="popoverLink" href="#"
    ...
    <td>
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-right"
          ...
          <li :class="{ disabled: mobileUser.token == null }">
            <a href="#" @click.prevent="$emit('revoke', mobileUser)">
...
export default {
  ...
  methods: {
    showCode() {
      this.$emit('show-code', this.mobileUser, this.$refs.popoverLink);
    }
  }
};
</script>
